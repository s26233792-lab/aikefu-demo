...
| 订单物流 | 订单 123456、手机尾号 7658 查物流 | 订单核验（手机号后四位）+ 物流 |
...
| `HANDOFF_HUMAN` | 情绪升级/投诉/要求转人工/超出能力 | 安抚并提醒人工；明确要求真人或客服主动接管时，Agent 才暂停当前会话 |
...
| **千帆 AI 常开** | 普通投诉创建人工任务但不永久停答；仅明确转人工或客服主动接管会暂停当前会话 |
...
浏览器打开 http://127.0.0.1:18081 。演示查单可使用订单号 `123456` 和手机尾号 `7658`。
